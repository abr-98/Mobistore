...
$rs = mysqli_query($conn, "select * from admin_panel where admin_id='$id'");
...
if (getErrCount() > 0)
{
   ...
   //echo $xxx;
  header('location: admin-passwordchange-form.php');
  exit();
}
...
if(!empty($passwd))
{
$sql = "UPDATE admin_panel SET admin_passwd='".md5($passwd)."' WHERE admin_id='$id'";
